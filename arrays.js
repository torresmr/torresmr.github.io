    ...
    getQuestionData(questionId) {
        const questionsData = {
            ...
            'is-palindrome': {
                ...
                complexity: 'Easy',
                examples: ['Input: "racecar" → Output: true', 'Input: "race a car" → Output: false']
            },
            'contains-duplicates-solution-brute': {
                description: 'Brute force solution using nested loops. Time complexity: O(n²)',
                complexity: 'Solution',
                examples: [],
                url: 'https://leetcode.com/problems/contains-duplicate/solutions/'
            },
            'two-sum-solution-brute': {
                description: 'Brute force solution using nested loops. Time complexity: O(n²)',
                complexity: 'Solution',
                examples: [],
                url: 'https://leetcode.com/problems/two-sum/solutions/'
            },
            'two-sum-solution-optimal': {
                description: 'Optimal solution using two pointers. Time complexity: O(n)',
                complexity: 'Solution',
                examples: [],
                url: 'https://leetcode.com/problems/two-sum/solutions/'
            },
            'is-palindrome-solution-brute': {
                description: 'Brute force solution comparing characters. Time complexity: O(n)',
                complexity: 'Solution',
                examples: [],
