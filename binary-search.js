...
class BinarySearchPage {
    ...
    getQuestionData(questionId) {
        const questionsData = {
            'search': {
                description: 'You are given an array of distinct integers nums, sorted in ascending order, and an integer target. Implement a function to search for target within nums. If it exists, then return its index, otherwise, return -1. Your solution must run in O(log(n))',
                complexity: 'Easy',
                examples: [ 'Input: nums = [-1,0,2,4,6,8], target = 4 Output: 3', 'Input: nums = [-1,0,2,4,6,8], target = 3 Output: -1']
            },
            'search-solution-optimal': {
                description: 'Optimal solution with binary search. Time complexity: O(log(n))',
                complexity: 'Solution',
                examples: [],
