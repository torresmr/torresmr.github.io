    ...
    getQuestionData(questionId) {
        const questionsData = {
            'invert-tree': {
                ...
                complexity: 'Easy',
                examples: [ 'Input: root = [1,2,3,4,5,6,7] Output: [1,3,2,7,6,5,4]', 'Input: root = [] Output: []']
            },
            'is-same-tree': {
                ...
                complexity: 'Easy',
                examples: ['Input: p = [1,2,3], q = [1,2,3] Output: true', 'Input: p = [4,7], q = [4,null,7] Output: false']
                
            },
            'invert-tree-solution-optimal': {
