    ...
    getQuestionData(questionId) {
        const questionsData = {
            'is-anagram': {
                ...
                complexity: 'Easy',
                examples: [ ' Input: s = "racecar", t = "carrace" Output: true', ' Input: s = "jar", t = "jam" Output: false']
            },
            'is-anagram-solution-optimal': {
                description: 'Optimal solution with hash map. Time complexity: O(n + m)',
                complexity: 'Solution',
                examples: [],
